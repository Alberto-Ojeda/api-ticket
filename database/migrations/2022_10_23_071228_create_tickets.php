...
class CreateTickets extends Migration
{
    ...
    public function up()
    {
        Schema::create('tickets', function (Blueprint $table) {
            ...
            $table->foreign('id_area')->references('id_area')->on('area_ticket')->onDelete('cascade');
            $table->unsignedSmallInteger('id_servicio_ticket');
            $table->foreign('id_servicio_ticket')->references('id_servicio_ticket')->on('servicio_ticket')->onDelete('cascade');
            $table->unsignedSmallInteger('id_ticket_status');
            $table->foreign('id_ticket_status')->references('id_ticket_status')->on('estado_ticket')->onDelete('cascade');
            $table->unsignedSmallInteger('id_prioridad');
            $table->foreign('id_prioridad')->references('id_prioridad')->on('prioridad_ticket')->onDelete('cascade');
